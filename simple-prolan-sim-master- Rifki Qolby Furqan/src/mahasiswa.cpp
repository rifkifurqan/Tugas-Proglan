...
mahasiswa::mahasiswa(std::string id, std::string nama,std::string namaibu, int dd, int mm, int yy, 
				std::string nrp, std::string departemen, int tahunmasuk)
		: person(id, nama, dd, mm, yy), nrp(nrp), departemen(departemen), tahunmasuk(tahunmasuk), namaibu(namaibu)
{
	this->ipk = 0.0;
	this->semesterke = 1;
	this->skslulus = 0;
...
std::string mahasiswa::getNamaibu()
{
	return this->namaibu;
}
